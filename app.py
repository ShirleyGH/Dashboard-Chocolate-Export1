...
# URLs de los archivos CSV desde tu GitHub
...
pais_seleccionado = st.selectbox("Selecciona un país para ver los detalles", paises, index=list(paises).index("Colombia"))
